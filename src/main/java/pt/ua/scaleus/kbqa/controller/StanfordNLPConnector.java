...
import pt.ua.scaleus.kbqa.nlp.MutableTree;
import pt.ua.scaleus.kbqa.nlp.MutableTreeNode;
 ...
 * returned Annotoation-Object to combineSequences(Annotation,KBQAQuestion) to
...
public class StanfordNLPConnector {
	...
	/**
	 * Copy Paste from pt.ua.scaleus.test.nlp.ParseTree to make this class independent from
	 ...
	 * 
	 * @param q The KBQAQuestion to be processed.
	...
	/**
	 * Runs a NounPhraseCombination and dependency parsing on given KBQAQuestion
	 * 
	...
	/**
	 * Runs a NounPhrasCombination and dependency parsing on given KBQAQuestion
	 * 
	 * @param q The Question you want to run NounPhraseCombination on
	 */
	 ...
	 * @param graph
	 */
	private void convertGraphStanford(final MutableTreeNode parentMutableNode, final IndexedWord parentGraphWord, final SemanticGraph graph, final KBQAQuestion q) {
	...
	public static void main(final String[] args) {
		...
		/// ---------------
		List<KBQAQuestion> questionsStanford;
